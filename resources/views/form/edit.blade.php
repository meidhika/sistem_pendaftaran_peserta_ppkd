...
@section('content')
    <form action="{{ route('formulir.update', $pesertas->id) }}" enctype="multipart/form-data" method="post">
        @csrf
        @method('PUT')
        <section>
            <div class="href-target" id="home"></div>
            <h1 class="package-name">Edit Respons</h1>
            <strong class="fs-5">Pendaftaran Program Reguler Angkatan III Tahun 2024</strong>
            <p>
        ...
        <section>
            ...
            <div class="nice-form-group">
                ...
                <select name="id_gelombang" id="">
                    ...
                    @foreach ($gelombangs as $gelombang)
                        <option {{ $gelombang->id == $pesertas->id_gelombang ? 'selected' : '' }}
                            value="{{ $gelombang->id }}">{{ $gelombang->nama_gelombang }}</option>
                    @endforeach
                </select>
            </div>
            <fieldset class="nice-form-group">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        @foreach ($jurusan1 as $key => $item1)
                            <div class="nice-form-group">
                                <input {{ $item1->id == $pesertas->id_jurusan ? 'checked' : '' }} type="radio"
                                    name="id_jurusan" id="{{ $item1->nama_jurusan }}" value="{{ $item1->id }}" />
                    ...
                    <div class="col-sm-6">
                        @foreach ($jurusan2 as $item2)
                            <div class="nice-form-group">
                                <input {{ $item2->id == $pesertas->id_jurusan ? 'checked' : '' }} type="radio"
                                    name="id_jurusan" id="{{ $item2->nama_jurusan }}" value="{{ $item2->id }}" />
            ...
            <div class="nice-form-group mb-3">
                <label>Screenshot Follow Instgaram PPKDssss</label>
                <small>Upload 1 Supported file: PDF, drawing, or image. Max 1 Mb</small>
                <div id="ss_instagramPreview" class="my-3">
                    <!-- Preview akan muncul di sini -->
                    <img src="{{ asset($pesertas->ss_instagram) }}" alt="" width="300px">
                </div>
                <input type="file" name="ss_instagram" onchange="previewFile(event, 'ss_instagramPreview')" /><br>
                <small>
        ...
        <section>
            ...
            <div class="nice-form-group">
                ...
                <input required type="text" placeholder="Email Anda" id="email" name="email"
                    value="{{ $pesertas->email }}">
            </div>

            <div class="nice-form-group">
                <label for="nama_lengkap">Nama Lengkap</label>
                <input required type="text" placeholder="Nama Lengkap" id="nama_lengkap" name="nama_lengkap"
                    value="{{ $pesertas->nama_lengkap }}">
            </div>

            <div class="nice-form-group">
                <label for="nik">NIK</label>
                <input required type="text" placeholder="NIK Anda" id="nik" name="nik"
                    value="{{ $pesertas->nik }}">
            </div>
            <div class="nice-form-group">
                <label for="kartu_keluarga">Nomor Kartu Keluarga</label>
                <input required type="text" placeholder="No Kartu Keluarga Anda" id="kartu_keluarga"
                    name="kartu_keluarga" value="{{ $pesertas->kartu_keluarga }}">
            </div>
            <fieldset class="nice-form-group">
                <label for="">Jenis Kelamin</label>
                <div class="nice-form-group">
                    <input {{ $pesertas->jenis_kelamin == 'laki-laki' ? 'checked' : '' }} type="radio"
                        name="jenis_kelamin" id="laki-laki" value="laki-laki" />
                    <label for="laki-laki">Laki-Laki</label>
                </div>

                <div class="nice-form-group">
                    <input {{ $pesertas->jenis_kelamin == 'perempuan' ? 'checked' : '' }} type="radio"
            ...
            <div class="nice-form-group">
                ...
                <input required type="text" placeholder="Tempat Lahir" id="tempat_lahir" name="tempat_lahir"
                    value="{{ $pesertas->tempat_lahir }}">
            </div>
            <div class="nice-form-group">
                <label for="tanggal_lahir">Tanggal Lahir</label>
                <input required type="date" placeholder="Tanggal Lahir" id="tanggal_lahir" name="tanggal_lahir"
                    value="{{ $pesertas->tanggal_lahir }}">
            </div>
            <div class="nice-form-group">
                <label for="nomor_hp">Nomor Hp</label>
                <input required type="text" placeholder="Nomor Handphone" id="nomor_hp" name="nomor_hp"
                    value="{{ $pesertas->nomor_hp }}">
            </div>
            <fieldset class="nice-form-group">
                <label for="">Apakah Anda Penyandang Disabilitas</label>
                <div class="nice-form-group">
                    <input {{ $pesertas->disabilitas == 'ya' ? 'checked' : '' }} type="radio" name="disabilitas"
                        id="ya_disabilitas" value="ya" />
                    <label for="ya_disabilitas">Ya</label>
                </div>

                <div class="nice-form-group">
                    <input {{ $pesertas->disabilitas == 'tidak' ? 'checked' : '' }} type="radio" name="disabilitas"
                        id="tidak_disabilitas" value="tidak" />
        ...
        <section>
            ...
            <fieldset class="nice-form-group">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="nice-form-group">
                            <input {{ $pesertas->pendidikan_terakhir == 'Tidak-Sekolah' ? 'checked' : '' }}
                                value="Tidak-Sekolah" type="radio" name="pendidikan_terakhir" id="tidak_sekolah" />
                            <label for="tidak_sekolah">Tidak Sekolah</label>
                        </div>
                        <div class="nice-form-group">
                            <input {{ $pesertas->pendidikan_terakhir == 'SD' ? 'checked' : '' }} value="SD"
                                type="radio" name="pendidikan_terakhir" id="sd" />
                            <label for="sd">SD</label>
                        </div>
                        <div class="nice-form-group">
                            <input {{ $pesertas->pendidikan_terakhir == 'SMP' ? 'checked' : '' }} value="SMP"
                                type="radio" name="pendidikan_terakhir" id="smp" />
                            <label for="smp">SMP</label>
                        </div>
                        <div class="nice-form-group">
                            <input {{ $pesertas->pendidikan_terakhir == 'SMA' ? 'checked' : '' }} value="SMA"
                                type="radio" name="pendidikan_terakhir" id="sma" />
                            <label for="sma">SMA</label>
                        </div>
                        <div class="nice-form-group">
                            <input {{ $pesertas->pendidikan_terakhir == 'SMK' ? 'checked' : '' }} value="SMK"
                                type="radio" name="pendidikan_terakhir" id="smk" />
                            <label for="smk">SMK</label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="nice-form-group">
                            <input {{ $pesertas->pendidikan_terakhir == 'D1' ? 'checked' : '' }} value="D1"
                                type="radio" name="pendidikan_terakhir" id="d1" />
                            <label for="d1">D1</label>
                        </div>
                        <div class="nice-form-group">
                            <input {{ $pesertas->pendidikan_terakhir == 'D2' ? 'checked' : '' }} value="D2"
                                type="radio" name="pendidikan_terakhir" id="d2" />
                            <label for="d2">D2</label>
                        </div>
                        <div class="nice-form-group">
                            <input {{ $pesertas->pendidikan_terakhir == 'D3' ? 'checked' : '' }} value="D3"
                                type="radio" name="pendidikan_terakhir" id="d3" />
                            <label for="d3">D3</label>
                        </div>
                        <div class="nice-form-group">
                            <input {{ $pesertas->pendidikan_terakhir == 'S1' ? 'checked' : '' }} value="S1"
                                type="radio" name="pendidikan_terakhir" id="s1" />
                            <label for="s1">S1</label>
                        </div>
                        <div class="nice-form-group">
                            <input {{ $pesertas->pendidikan_terakhir == 'S2-S3' ? 'checked' : '' }} value="S2-S3"
                                type="radio" name="pendidikan_terakhir" id="s2-s3" />
        ...
        <section>
            ...
            <fieldset class="nice-form-group">
                ...
                <div class="nice-form-group">
                    <input {{ $pesertas->aktivitas_saat_ini == 'sekolah' ? 'checked' : '' }} type="radio"
                        name="aktivitas_saat_ini" id="sekolah" value="sekolah" />
                    <label for="sekolah">Sekolah / Kuliah</label>
                </div>

                <div class="nice-form-group">
                    <input {{ $pesertas->aktivitas_saat_ini == 'cari_kerja' ? 'checked' : '' }} type="radio"
                        name="aktivitas_saat_ini" id="cari_kerja" value="cari_kerja" />
                    <label for="cari_kerja">Pencari Kerja, Belum Ada Kegiatan di Pagi dan Siang Hari</label>
                </div>
                <div class="nice-form-group">
                    <input {{ $pesertas->aktivitas_saat_ini == 'bekerja_malam' ? 'checked' : '' }} type="radio"
                        name="aktivitas_saat_ini" id="bekerja" value="bekerja_malam" />
        ...
        <section>
            ...
            <fieldset class="nice-form-group">
                ...
                <div class="nice-form-group">
                    <input {{ $pesertas->rumah_susun == 'ya' ? 'checked' : '' }} type="radio" name="rumah_susun"
                        id="ya_susun" value="ya" />
                    <label for="ya_susun">Ya</label>
                </div>

                <div class="nice-form-group">
                    <input {{ $pesertas->rumah_susun == 'tidak' ? 'checked' : '' }} type="radio" name="rumah_susun"
                        id="tidak_susun" value="tidak" />
            ...
            <div class="nice-form-group">
                ...
                <input value="{{ $pesertas->alamat_rumah }}" type="text" placeholder="Alamat Rumah"
                    name="alamat_rumah" id="alamat_rumah" />
            </div>
            <div class="nice-form-group">
                <label for="rt">RT*</label>
                <input value="{{ $pesertas->rt }}" type="text" placeholder="RT" name="rt" id="rt" />
            </div>
            <div class="nice-form-group">
                <label for="rw">RW*</label>
                <input value="{{ $pesertas->rw }}" type="text" placeholder="RW" name="rw" id="rw" />
            </div>
            <div class="nice-form-group">
                <label for="kelurahan">Kelurahan*</label>
                <input value="{{ $pesertas->kelurahan }}" type="text" placeholder="Kelurahan" name="kelurahan"
                    id="kelurahan" />
            </div>
            <div class="nice-form-group">
                <label for="kecamatan">Kecamatan*</label>
                <input value="{{ $pesertas->kecamatan }}" type="text" placeholder="Kecamatan" name="kecamatan"
                    id="kecamatan" />
            </div>
            <fieldset class="nice-form-group">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="nice-form-group">
                            <input {{ $pesertas->kota_madya == 'jakarta_pusat' ? 'checked' : '' }} type="radio"
                                name="kota_madya" value="jakarta_pusat" id="jakarta_pusat" />
                            <label for="jakarta_pusat">Jakarta Pusat</label>
                        </div>

                        <div class="nice-form-group">
                            <input {{ $pesertas->kota_madya == 'jakarta_utara' ? 'checked' : '' }} type="radio"
                                name="kota_madya" value="jakarta_utara" id="jakarta_utara" />
                            <label for="jakarta_utara">Jakarta Utara</label>
                        </div>
                        <div class="nice-form-group">
                            <input {{ $pesertas->kota_madya == 'jakarta_selatan' ? 'checked' : '' }} type="radio"
                                name="kota_madya" value="jakarta_selatan" id="jakarta_selatan" />
                            <label for="jakarta_selatan">Jakarta Selatan</label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="nice-form-group">
                            <input {{ $pesertas->kota_madya == 'jakarta_timur' ? 'checked' : '' }} type="radio"
                                name="kota_madya" value="jakarta_timur" id="jakarta_timur" />
                            <label for="jakarta_timur">Jakarta Timur</label>
                        </div>

                        <div class="nice-form-group">
                            <input {{ $pesertas->kota_madya == 'jakarta_barat' ? 'checked' : '' }} type="radio"
                                name="kota_madya" value="jakarta_barat" id="jakarta_barat" />
                            <label for="jakarta_barat">Jakarta Barat</label>
                        </div>
                        <div class="nice-form-group">
                            <input {{ $pesertas->kota_madya == 'kepulauan_seribu' ? 'checked' : '' }} type="radio"
                                name="kota_madya" value="kepulauan_seribu" id="kepulauan_seribu" />
        ...
        <section>
            ...
            <div class="nice-form-group mb-3">
                ...
                <div id="ktp_preview" class="my-3">
                    <!-- Preview akan muncul di sini -->
                    <img src="{{ asset($pesertas->file_ktp) }}" alt="" width="300px">
                </div>
                <input type="file" name="file_ktp" onchange="previewFile(event, 'ktp_preview')" />
            </div>
            <div class="nice-form-group mb-3">
                ...
                <div id="domisili_preview" class="my-3">
                    <!-- Preview akan muncul di sini -->
                    <img src="{{ asset($pesertas->file_domisili) }}" alt="" width="300px">
                </div>
                <input type="file" name="file_domisili" onchange="previewFile(event, 'domisili_preview')" />
            </div>
            <div class="nice-form-group mb-3">
                ...
                <div id="kk_preview" class="my-3">
                    <!-- Preview akan muncul di sini -->
                    <img src="{{ asset($pesertas->file_kk) }}" alt="" width="300px">
                </div>
                <input type="file" name="file_kk" onchange="previewFile(event, 'kk_preview')" />
            </div>
            <div class="nice-form-group mb-3">
                ...
                <div id="ijasah_preview" class="my-3">
                    <!-- Preview akan muncul di sini -->
                    <img src="{{ asset($pesertas->file_ijasah) }}" alt="" width="300px">
                </div>
                <input type="file" name="file_ijasah" onchange="previewFile(event, 'ijasah_preview')" />
            </div>
            <div class="nice-form-group mb-3">
                ...
                <div id="photo_preview" class="my-3">
                    <!-- Preview akan muncul di sini -->
                    <img src="{{ asset($pesertas->photo) }}" alt="" width="300px">
                </div>
                <label>Ukuran 3 x 4</label>
                <small>Upload 1 Supported file: PDF, drawing, or image. Max 1 Mb</small>
                <input type="file" name="photo" onchange="previewFile(event, 'photo_preview')" />
            </div>
            <div class="nice-form-group mb-3">
                ...
                <div id="vaksin_preview" class="my-3">
                    <!-- Preview akan muncul di sini -->
                    <img src="{{ asset($pesertas->file_vaksin) }}" alt="" width="300px">
                </div>
                <input type="file" name="file_vaksin" onchange="previewFile(event, 'vaksin_preview')" />
            </div>
        </section>
        ...
        <section>
            ...
            <div class="nice-form-group mb-3">
                ...
                <div class="nice-form-group">
                    <input required type="radio" name="persetujuan" id="persetujuan-pelatihan" value="setuju" />
        ...
        function previewFile(event, previewId) {
            ...
            if (file) {
                ...
                if (fileType.startsWith('image/')) {
                    ...
                    embed.src = URL.createObjectURL(file); // Membuat URL sementara untuk PDF
